...
import io.cucumber.examples.spring.Message;
import io.cucumber.examples.spring.MessageRepository;
...
public class MessageStepDefinitions {
    ...
    public MessageStepDefinitions(MessageRepository messageRepository, UserStepDefinitions userStepDefinitions) {
